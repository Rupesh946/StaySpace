            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[440px] bg-white p-12 z-[101] shadow-2xl"
                    >
                        <button
                            onClick={onClose}
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            <form className="w-full space-y-8">
                                ...
                                <button className="w-full bg-black text-white py-4 text-xs uppercase tracking-[0.2em] hover:bg-terracotta transition-colors duration-300 mt-8">
